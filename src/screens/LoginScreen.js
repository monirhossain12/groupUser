...
<div class="limiter">
		<div class="container-login100" style={{backgroundImage: `url(${bg})`}}>
			<div class="wrap-login100">
				<form class="login100-form validate-form" onSubmit={handleSubmit(loginUser)}>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Email"> 
						<input class="input100" type="email" name="email" {...register('email')} placeholder="Email" autoComplete='off'/>
						<span class="focus-input100" data-placeholder="&#xf0e0;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="password" {...register('password')} placeholder="Password" autoComplete='off'/>
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					...
					<Link className='txt1' to="/signup">Sign Up instead</Link>
					</div>
				</form>
			</div>
		</div>
